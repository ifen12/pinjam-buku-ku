...
--
-- Host: 127.0.0.1
-- Generation Time: 17 Des 2018 pada 02.10
...
CREATE TABLE `users` (
  ...
  `pilih` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `name`, `username`, `password`, `pilih`, `remember_token`, `created_at`, `updated_at`) VALUES
(16, 'fendi', 'ifen', '$2y$10$UhUM.nFyhLXj30kmmzRJKOGNceBzMMdYX2AzqMQuv714W40OfjJzS', 'ADMIN', 'Gae2dRiqYCp68scWrrptB2jJcbG8eKNxTrGc8t4dabA1jxV2nR1LIv2q45Lv', '2018-12-16 09:28:10', '2018-12-16 09:28:10'),
(17, 'user', 'user', '$2y$10$KBTdux08leAtRe9iz5CmZ.RIp7A.KuCSl5AosxqazjCZW9AylygWe', 'USER', '8K92oRJOgdZiVNrWMNdGQU1fQO63Pe5bD6VDtH5TM8P3IrUxZr4byyxqi25z', '2018-12-16 09:30:41', '2018-12-16 09:30:41');
