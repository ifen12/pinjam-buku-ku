				...
				<tbody>
					<tr>
						...
						<td>
							<ul>
								<li>
									<a href="/siswa/{{$siswa->nis}}" class="waves-effect waves-light btn green www" type="submit" name="action">
										<i class="material-icons right aaa">visibility</i><p id="qqq">detail</p>
									</a>
								</li>
								<li>
									<a href="/siswa/{{$siswa->nis}}/edit" class="waves-effect waves-light btn blue www" type="submit" name="action">
